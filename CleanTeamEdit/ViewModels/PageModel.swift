...
struct Page: Identifiable, Equatable {
    ...
    static var samplePages: [Page] = [
        ...
        Page(name: "Congrats!", description: "You’re ready to get started. Say goodbye to roommate horror stories and hello to CleanTeam!", image: "Congratulations Screen", tag: 5),
    ]
}
